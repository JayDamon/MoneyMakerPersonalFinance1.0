 ...
 */
public class NewTransferController implements Initializable {
    ...
    private String toTransactionID, fromTransactionID;
    ...
    private void addFromTransaction(String transactionID, String date, String description, String amount) {
    ...
    private void addToTransaction(String transactionID, String date, String description, String amount) {
    ...
    private void submitTransfer() {
        ...
        if (!requiredFieldsAreEmpty) {
            ...
            sqlTransfer.newTransfer(transferDate, this.fromTransactionID, this.toTransactionID, transferAmount);
    ...
    private void newFromTransaction() {
        ...
        try {
            ...
            stage.initOwner(anchorPaneNewTransfer.getScene().getWindow());
